...
1. Launch the app and log in with a username, email, and password
2. Add a task with a description, priority, and optional due date
3. Check off tasks as you complete them to earn XP
4. Watch your progress bar and level indicator update in real time
5. Receive an email confirmation each time you finish a task

 

*Built as a JavaFX learning project combining desktop UI, database persistence, and gamification.*
